/*
 * 凪 stroke paths, shared by the preloader and the manifesto kanji.
 * Stroke data from KanjiVG (http://kanjivg.tagaini.net),
 * Copyright Ulrich Apel, CC BY-SA 3.0.
 */
export const NAGI_STROKES = [
  'M25.8,16.5c1.29,1.29,1.37,2.55,1.37,4.86c0,28.26-0.04,55.01-15.16,72.89',
  ...
  'M25.44,90.12c3.17,0.97,6.45,0.54,9.69,0.33c10.24-0.66,26.51-2.01,37.63-2.34c3.53-0.11,7.07,0.11,10.55,0.81',
]
